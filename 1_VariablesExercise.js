...
// num2 but not num1?
// num1 can only be a number between 2 and 9.
// num2 can be any number from 1 to 10 (inclusive).
// Therefore, the valid values for num2 that are not valid for num1 are 1 and 10.
